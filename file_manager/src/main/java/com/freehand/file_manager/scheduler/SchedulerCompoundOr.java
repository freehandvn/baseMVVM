 ...
 * Purpose: scheduler combine all child scheduler by operator or
 */

public class SchedulerCompoundOr implements IScheduler {

    private final IScheduler[] schedulers;

    public SchedulerCompoundOr(@NonNull IScheduler... schedulers) {
