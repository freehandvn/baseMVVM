 ...
 * Purpose: Filter combine all child filter by and operator and
 */

public class FilterCompoundAnd extends AFilter {

    private AFilter[] args;

    public FilterCompoundAnd(@NonNull AFilter... args) {
        super(args);
        this.args = args;
    }

    public FilterCompoundAnd() {
        super();
    }
    ...
    public boolean accept(File file) {
        ...
        for (AFilter rule : args) {
            if (!rule.accept(file)) return false;
        }
        return true;
    }
