 ...
 */
public class StatefulRelativeLayout extends RelativeLayout implements IStatefulView {

    StatefulCore core = new StatefulCore();

    public StatefulRelativeLayout(@NonNull Context context) {
        super(context);
    }

    public StatefulRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public StatefulRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public StatefulRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
