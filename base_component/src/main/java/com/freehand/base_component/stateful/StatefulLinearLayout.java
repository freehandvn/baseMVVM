 ...
 */
public class StatefulLinearLayout extends LinearLayout implements IStatefulView {

    StatefulCore core = new StatefulCore();

    public StatefulLinearLayout(@NonNull Context context) {
        super(context);
    }

    public StatefulLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public StatefulLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public StatefulLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
